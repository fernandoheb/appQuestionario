...
<?php
			...
			//alterar endereço
			//$imagemgerada = "http://ec2-52-67-168-150.sa-east-1.compute.amazonaws.com/questionario/geraimg.php?fixface=".time()."&img1=".$geraimgv[1]."&img2=".$geraimgv[2]."&img3=".$geraimgv[3]."&img4=".$geraimgv[4]."&img5=".$geraimgv[5]."&img6=".$geraimgv[6]."&img7=".$geraimgv[7]."&img8=".$geraimgv[8]."&img9=".$geraimgv[9]."&img10=".$geraimgv[10];
...
<br><br>
							<div class="text-center" id="b3">
										...
										<a  class="btn btn-primary" href="http://ec2-52-67-168-150.sa-east-1.compute.amazonaws.com/questionario/index.php">
...
<center><div class="fb-share-button" data-href="<?php echo $url; ?>" data-layout="button"></div></center><br>
				...
				?>
					<br>
					    <center>
						<!-- alterar endereço -->
					        <a href="http://ec2-52-67-168-150.sa-east-1.compute.amazonaws.com/questionario/colaboradores.php"><input type="button" class="btn-primary" value="Quem somos"></input></a>
					        <br><br>
...
<div class="col-sm-12"><p>Email de contato para sugestões e comentários: sisotani@icmc.usp.br</p></div>
		...
		<script>
			...
			$(".submitConcordo").click(function (e) {
            	var check = $(this).attr("alt");//pega o atributo alt do ultimo elemento instanciado.
            		...
            		document.getElementById("form-group").style.display="none";
						//alterar o endereço
            			$.ajax({
					url : 'http://ec2-52-67-168-150.sa-east-1.compute.amazonaws.com/questionario/saveData2.php?concordo',
					type: 'POST',
					dataType: 'json',
			...
			if(check=="nao"){
				//alterar o endereço
			url = "http://ec2-52-67-168-150.sa-east-1.compute.amazonaws.com/questionario/nconcordo.php?id="+idResposta;
	...
	//		window.location.assign('http://200.144.255.42:8003/questionario/index.php');
			...
			function finalizar(){//alterar o endereco
				window.location.assign('http://ec2-52-67-168-150.sa-east-1.compute.amazonaws.com/questionario/index.php');
			}
